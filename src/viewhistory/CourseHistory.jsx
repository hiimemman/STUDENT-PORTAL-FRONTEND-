...
const [actionFileSave, setActionFileSave] = useState('');
  ...
  const handleCloseDialog = () => {
    ...
    const getData = async () =>{
      isLoading(true)
        const sendRequest = await fetch(basedUrl+"/course-history.php");
    ...
    const restoreFile = async () =>{
      ...
      dataRestore.append('Course_Name', fileSave['course_name']);
      dataRestore.append('Description', fileSave['description']);
      dataRestore.append('Course_Faculty', fileSave['course_faculty']);
      dataRestore.append('Status', fileSave['status']);
        ...
        dataRestore.append('Category', 'Course');
          ...
          maxHeight: 450, overflow: 'auto'}} className ="rounded-xl">
           ...
           <Divider />
            <Grid2 container spacing={2} sx ={{marginLeft:'0px'}}>
             ...
             <Grid2 item xs={4}><Typography variant='overline'>{fileSave.course_name}</Typography></Grid2>
            </Grid2>
            <Grid2 container spacing={2} sx ={{marginLeft:'0px'}}>
             <Grid2 item xs={4}><Typography variant='overline'>DESCRIPTION:</Typography></Grid2>
             <Grid2 item xs={4}><Typography variant='overline'>{fileSave.description}</Typography></Grid2>
            </Grid2>
            <Grid2 container spacing={2} sx ={{marginLeft:'0px'}}>
             <Grid2 item xs={4}><Typography variant='overline'>FACULTY:</Typography></Grid2>
             <Grid2 item xs={4}><Typography variant='overline'>{fileSave.course_faculty}</Typography></Grid2>
            </Grid2>
            <Grid2 container spacing={2} sx ={{marginLeft:'0px'}}>
            ...
            <Grid2 container spacing={2} sx ={{marginLeft:'0px'}}>
             <Grid2 item xs={4}><Typography variant='overline'>DATE_CREATED:</Typography></Grid2>
             <Grid2 item xs={4}><Typography variant='overline'>{fileSave.added_at}</Typography></Grid2>
            </Grid2>
          </Paper>
        </Draggable>
      )}
