...
const [actionFileSave, setActionFileSave] = useState('');
  ...
  const handleCloseDialog = () => {
    ...
    const getData = async () =>{
      isLoading(true)
        const sendRequest = await fetch(basedUrl+"/faculty-history.php");
    ...
    const restoreFile = async () =>{
      try{
        ...
        dataRestore.append('Faculty', fileSave.faculty_name);
        ...
        dataRestore.append('Category', 'Faculty');
          ...
          maxHeight: 450, overflow: 'auto'}} className ="rounded-xl">
           ...
           <Divider />
            <Grid2 container spacing={2} sx ={{marginLeft:'0px'}}>
             ...
             <Grid2 item xs={4}><Typography variant='overline'>{fileSave.faculty_name}</Typography></Grid2>
            </Grid2>
            <Grid2 container spacing={2} sx ={{marginLeft:'0px'}}>
