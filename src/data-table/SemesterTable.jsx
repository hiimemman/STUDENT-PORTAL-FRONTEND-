  ...
  useEffect( () => {
   const getAllData = async () =>{
      ...
      try{ 
        ...
        //online api
          const sendRequest = await fetch(basedUrl+"/semester-table.php");
...
const checkStatus = (values) =>{
  ...
  const handleYes = async () => {
    ...
    try {
      ...
      dataUpdate.append('Category', 'Semester');
      const response = await mutateRow(newRow);
      const sendRequest = await fetch(basedUrl+"/semester-update.php",{
        method: "POST",
        body: dataUpdate,
    });
